...
;(function () {
  ...
  function expandConfig (config) {
    ...
    if (!config.hasOwnProperty('pieceTheme') ||
      ...
      config.pieceTheme = 'static/images/{piece}.png'
    }
  ...
  function constructor (containerElOrString, config) {
    ...
    function calculateSquareSize () {
      var containerHeight = parseInt($container.parent('div').height(), 10)
      ...
      return Math.round(containerHeight * (7/64)); // divide by 8, multiply by 7/8 to make space for timers/usernames
    }
